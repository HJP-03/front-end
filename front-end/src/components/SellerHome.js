...
const SellerHome = () => {
  ...
  return (
    <div className="bg-surface text-on-surface font-body min-h-screen selection:bg-primary selection:text-on-primary">
      {/* TopAppBar */}
      <nav className="fixed top-0 w-full z-50 flex justify-between items-center px-8 h-16 bg-black/40 backdrop-blur-xl text-[#8ff5ff] font-headline tracking-tight border-b border-[#8ff5ff]/10 shadow-[0_4px_30px_rgba(0,0,0,0.1)]">
        <div className="text-2xl font-black italic text-[#8ff5ff] drop-shadow-[0_0_8px_rgba(143,245,255,0.5)] uppercase tracking-tighter">대학생 공동주문 마켓</div>
        <div className="hidden md:flex space-x-8 items-center">
          <a className="text-[#adaaaa] hover:text-[#8ff5ff] transition-colors text-sm font-bold uppercase tracking-widest" href="#">대시보드</a>
          <a className="text-[#adaaaa] hover:text-[#8ff5ff] transition-colors text-sm font-bold uppercase tracking-widest" href="#">마켓</a>
          <a className="text-[#adaaaa] hover:text-[#8ff5ff] transition-colors text-sm font-bold uppercase tracking-widest" href="#">주문관리</a>
          <a className="text-[#adaaaa] hover:text-[#8ff5ff] transition-colors text-sm font-bold uppercase tracking-widest" href="#">커뮤니티</a>
        </div>
        <div className="flex items-center space-x-4">
          <button className="p-2 hover:bg-[#8ff5ff]/10 rounded-full transition-all active:scale-90"><span className="material-symbols-outlined">notifications</span></button>
          <button className="p-2 hover:bg-[#8ff5ff]/10 rounded-full active:scale-90"><span className="material-symbols-outlined">account_circle</span></button>
        </div>
      </nav>

      {/* SideNavBar */}
      <aside className="fixed left-0 top-16 h-[calc(100vh-64px)] w-64 bg-[#0e0e0e] border-r border-[#8ff5ff]/5 flex flex-col hidden lg:flex shadow-[10px_0_30px_rgba(0,0,0,0.5)] z-40">
        <div className="p-6">
          <div className="flex items-center space-x-3 mb-8">
            ...
            <div>
              <h3 className="text-xs font-bold uppercase tracking-widest font-headline text-white tracking-tighter">판매자 워크스페이스</h3>
          ...
          <nav className="space-y-2 font-headline uppercase text-sm tracking-widest font-bold">
            <a className="flex items-center space-x-4 text-[#adaaaa] px-4 py-3 hover:translate-x-2 transition-transform" href="#"><span className="material-symbols-outlined">dashboard</span><span>개요</span></a>
            <a className="flex items-center space-x-4 bg-gradient-to-r from-[#8ff5ff]/20 to-transparent text-[#8ff5ff] border-l-4 border-[#8ff5ff] px-4 py-3" href="#"><span className="material-symbols-outlined">inventory_2</span><span>인벤토리</span></a>
            <a className="flex items-center space-x-4 text-[#adaaaa] px-4 py-3 hover:translate-x-2 transition-transform" href="#"><span className="material-symbols-outlined">local_shipping</span><span>물류 현황</span></a>
            <a className="flex items-center space-x-4 text-[#adaaaa] px-4 py-3 hover:translate-x-2 transition-transform" href="#"><span className="material-symbols-outlined">insights</span><span>분석 데이터</span></a>
          </nav>
        </div>
        <div className="mt-auto p-6 space-y-4">
          <button 
            onClick={() => navigate('/login')}
            className="w-full py-3 px-4 bg-primary text-on-primary font-bold rounded-lg shadow-[0_0_20px_rgba(143,245,255,0.3)] hover:brightness-110 transition-all text-xs uppercase tracking-widest"
          >
            리포트 생성
          </button>
          <div className="flex flex-col space-y-2 border-t border-outline-variant/20 pt-4">
            <a className="flex items-center space-x-3 text-[#adaaaa] text-xs hover:text-primary transition-colors font-bold uppercase tracking-widest" href="#"><span className="material-symbols-outlined text-sm">settings</span><span>설정</span></a>
      ...
      <main className="lg:ml-64 pt-24 pb-32 px-6 md:px-12 max-w-7xl mx-auto">
        <header className="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-6 uppercase">
          <div><h1 className="font-headline text-5xl md:text-6xl font-black tracking-tighter mb-2 text-white">판매자<br/><span className="text-primary drop-shadow-[0_0_15px_rgba(143,245,255,0.4)]">대시보드</span></h1><p className="text-on-surface-variant max-w-md font-medium text-sm">중고 도서 매물을 등록하고 공동구매 참여자들과 실시간으로 소통하세요.</p></div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          {/* 도서 등록 폼 */}
          <section className="lg:col-span-4 bg-surface-container rounded-3xl p-8 border border-white/5 relative overflow-hidden">
            <div className="absolute top-0 right-0 w-32 h-32 bg-primary/5 blur-3xl rounded-full"></div>
            <h2 className="font-headline text-xl font-bold mb-8 flex items-center gap-2 text-white"><span className="material-symbols-outlined text-primary">book</span>도서 등록</h2>
            <form className="space-y-6">
              ...
              <button 
                onClick={() => navigate('/login')}
                className="w-full mt-4 py-4 bg-primary text-on-primary font-black rounded-xl hover:shadow-[0_0_30px_rgba(143,245,255,0.4)] hover:scale-[1.02] active:scale-[0.98] transition-all uppercase tracking-widest text-xs"
              >
                도서 등록 완료
              </button>
            </form>
          ...
          {/* 에디터 섹션 */}
          <section className="lg:col-span-8 bg-surface-container rounded-3xl p-8 border border-white/5">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4 uppercase font-bold">
              <h2 className="font-headline text-xl font-bold flex items-center gap-2 text-white"><span className="material-symbols-outlined text-secondary">edit_note</span>상세 정보 에디터</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-3 gap-3">
                  <div className="aspect-square bg-surface-container-highest rounded-xl overflow-hidden border border-white/10 group relative">
          ...
          {/* 판매 달성도 섹션 */}
          <section className="lg:col-span-5 bg-surface-container rounded-3xl p-8 border border-white/5 flex flex-col">
            <h2 className="font-headline text-xl font-bold mb-6 flex items-center gap-2 text-white"><span className="material-symbols-outlined text-primary">monitoring</span>판매 달성도</h2>
            <div className="flex-1 space-y-6">
              <div className="flex justify-between items-end">
                <div><p className="text-4xl font-headline font-black text-white">12<span className="text-primary text-xl">/15</span></p><p className="text-[10px] uppercase font-bold text-on-surface-variant tracking-widest">누적 입찰 수</p></div>
              ...
              <div className="h-4 w-full bg-surface-container-highest rounded-full overflow-hidden"><div className="h-full bg-gradient-to-r from-primary to-secondary rounded-full shadow-[0_0_15px_rgba(143,245,255,0.4)]" style={{width: '80%'}}></div></div>
              <div className="space-y-3 pt-4">
                <div className="flex items-center gap-3 p-3 bg-surface-container-low rounded-xl border border-primary/10"><span className="material-symbols-outlined text-primary text-sm" style={{fontVariationSettings: "'FILL' 1"}}>check_circle</span><span className="text-[10px] font-bold uppercase text-white tracking-wider">에스크로 시스템 활성화</span></div>
                <div className="flex items-center gap-3 p-3 bg-surface-container-low rounded-xl border border-primary/10"><span className="material-symbols-outlined text-primary text-sm" style={{fontVariationSettings: "'FILL' 1"}}>check_circle</span><span className="text-[10px] font-bold uppercase text-white tracking-wider">안심 택배 서비스 연동</span></div>
            ...
            <div className="mt-8 pt-6 border-t border-white/5 uppercase">
          ...
          {/* 구매자 문의 채팅 위젯 */}
          <section className="lg:col-span-7 bg-surface-container rounded-3xl border border-white/5 overflow-hidden flex flex-col min-h-[450px]">
            <div className="p-6 border-b border-white/5 bg-surface-container-high flex justify-between items-center"><h2 className="font-headline text-xl font-bold text-white flex items-center gap-2">구매자 문의 <span className="w-2 h-2 bg-primary rounded-full animate-pulse"></span></h2><button className="text-[10px] font-bold text-primary uppercase tracking-widest">모두 읽음</button></div>
            <div className="flex flex-1 overflow-hidden">
              <div className="w-1/3 border-r border-white/5 overflow-y-auto bg-surface-container-low">
                <div className="p-4 bg-primary/10 border-l-4 border-primary"><div className="flex justify-between items-start mb-1 text-white text-[10px] font-bold"><span>김민준</span><span>2분 전</span></div><p className="text-[10px] text-on-surface-variant line-clamp-2">책 안쪽에 형광펜 낙서가 심한가요?</p></div>
                <div className="p-4 border-b border-white/5 hover:bg-surface-container-high cursor-pointer transition-colors"><div className="flex justify-between items-start mb-1 text-white text-[10px] font-bold"><span>이지혜</span><span>14분 전</span></div><p className="text-[10px] text-on-surface-variant line-clamp-1">배송지 변경 가능한가요?</p></div>
              </div>
              <div className="flex-1 flex flex-col relative">
                <div className="flex-1 p-6 space-y-4 overflow-y-auto">
                  <div className="flex gap-3">
                    ...
                    <div className="bg-surface-container-highest p-3 rounded-2xl rounded-tl-none max-w-[80%] text-xs text-white leading-relaxed">안녕하세요! 도서 책등 부분에 갈라짐이 있는지 알고 싶습니다.</div>
                  </div>
                  <div className="flex gap-3 flex-row-reverse">
                    ...
                    <div className="bg-primary/10 p-3 rounded-2xl rounded-tr-none max-w-[80%] border border-primary/10 text-xs text-white leading-relaxed">반갑습니다. 해당 도서는 암소 보관되어 상태가 매우 좋습니다. 상세 컷을 추가했으니 확인 부탁드려요!</div>
                  </div>
                </div>
                <div className="p-4 bg-surface-container-high border-t border-white/5 relative">
                  <input className="w-full bg-surface border-none rounded-xl py-3 pl-4 pr-12 text-xs text-white outline-none focus:ring-1 focus:ring-primary" placeholder="답변을 입력하세요..." type="text"/>
      ...
      <nav className="fixed bottom-0 w-full z-50 flex justify-around items-center px-6 pb-6 pt-3 md:hidden bg-[#0e0e0e]/80 backdrop-blur-2xl rounded-t-[2rem] border-t border-[#8ff5ff]/10 shadow-[0_-10px_40px_rgba(143,245,255,0.1)]">
        <button className="flex flex-col items-center justify-center text-[#adaaaa] p-2 hover:text-[#8ff5ff] transition-transform scale-110">
        ...
        <button className="flex flex-col items-center justify-center bg-[#8ff5ff] text-[#0e0e0e] rounded-2xl p-2 shadow-[0_0_20px_rgba(143,245,255,0.6)] transition-transform scale-110">
