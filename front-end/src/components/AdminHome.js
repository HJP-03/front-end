...
const AdminHome = () => {
  ...
  return (
    <div className="bg-surface text-on-surface font-body min-h-screen overflow-x-hidden selection:bg-primary selection:text-on-primary">
      {/* TopNavBar */}
      <nav className="fixed top-0 w-full z-50 flex justify-between items-center px-8 h-16 bg-black/40 backdrop-blur-xl border-b border-[#8ff5ff]/10">
        <div className="flex items-center gap-12">
          ...
          <div className="hidden lg:flex items-center gap-8 font-headline tracking-tight text-sm">
            <a className="text-[#adaaaa] hover:text-[#8ff5ff] transition-colors uppercase font-bold tracking-widest" href="#">대시보드</a>
            <a className="text-[#adaaaa] hover:text-[#8ff5ff] transition-colors uppercase font-bold tracking-widest" href="#">마켓</a>
            <a className="text-[#adaaaa] hover:text-[#8ff5ff] transition-colors uppercase font-bold tracking-widest" href="#">주문 내역</a>
            <a className="text-[#adaaaa] hover:text-[#8ff5ff] transition-colors uppercase font-bold tracking-widest" href="#">커뮤니티</a>
          </div>
        </div>
        <div className="flex items-center gap-6">
          <div className="relative group hidden sm:block">
            <span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-on-surface-variant text-sm">search</span>
            <input className="bg-surface-container-highest border-none rounded-full py-2 pl-10 pr-4 text-xs w-64 focus:ring-1 focus:ring-primary outline-none text-white placeholder:text-on-surface-variant/50" placeholder="통합 검색..." type="text"/>
          </div>
          <div className="flex items-center gap-4 text-[#8ff5ff]">
            <button className="hover:bg-[#8ff5ff]/10 p-2 rounded-full transition-transform active:scale-90"><span className="material-symbols-outlined">notifications</span></button>
            <button className="hover:bg-[#8ff5ff]/10 p-1 rounded-full border border-primary/20 transition-transform active:scale-90"><span className="material-symbols-outlined text-3xl">account_circle</span></button>
          </div>
        </div>
      </nav>

      {/* SideNavBar */}
      <aside className="fixed left-0 top-16 h-[calc(100vh-64px)] w-64 bg-[#0e0e0e] border-r border-[#8ff5ff]/5 flex flex-col z-40 hidden lg:flex shadow-[10px_0_30px_rgba(0,0,0,0.5)]">
        <div className="p-6 border-b border-surface-container text-white">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-headline text-sm uppercase tracking-widest text-[#8ff5ff] tracking-tighter">시스템 제어 센터</p>
        ...
        <div className="flex-1 py-6 space-y-1 font-headline text-sm uppercase tracking-widest font-bold">
          <a className="bg-gradient-to-r from-[#8ff5ff]/20 to-transparent text-[#8ff5ff] border-l-4 border-[#8ff5ff] px-6 py-3 flex items-center gap-4" href="#"><span className="material-symbols-outlined text-xl">dashboard</span>대시보드 개요</a>
          <a className="text-[#adaaaa] px-6 py-3 flex items-center gap-4 hover:translate-x-2 transition-transform hover:bg-[#1a1919]" href="#"><span className="material-symbols-outlined text-xl">group</span>회원 관리</a>
          <a className="text-[#adaaaa] px-6 py-3 flex items-center gap-4 hover:translate-x-2 transition-transform hover:bg-[#1a1919]" href="#"><span className="material-symbols-outlined text-xl">inventory_2</span>재고 현황</a>
          <a className="text-[#adaaaa] px-6 py-3 flex items-center gap-4 hover:translate-x-2 transition-transform hover:bg-[#1a1919]" href="#"><span className="material-symbols-outlined text-xl">local_shipping</span>물류 시스템</a>
          <a className="text-[#adaaaa] px-6 py-3 flex items-center gap-4 hover:translate-x-2 transition-transform hover:bg-[#1a1919]" href="#"><span className="material-symbols-outlined text-xl">insights</span>통계 분석</a>
        </div>
        <div className="p-6 space-y-4">
          <button 
            onClick={() => navigate('/login')}
            className="w-full py-3 px-4 bg-primary text-on-primary rounded-lg font-bold text-xs uppercase tracking-widest shadow-[0_0_15px_rgba(143,245,255,0.3)] hover:brightness-110 transition-all uppercase"
          >
            보고서 생성
          </button>
          <div className="pt-4 border-t border-surface-container font-headline uppercase text-xs tracking-widest font-bold">
            <a className="text-[#adaaaa] py-2 flex items-center gap-4 hover:text-[#8ff5ff] transition-colors" href="#"><span className="material-symbols-outlined text-xl">settings</span>설정</a>
      ...
      <main className="lg:ml-64 pt-16 min-h-screen pb-24 md:pb-8">
        ...
        <section className="relative h-[450px] w-full overflow-hidden flex items-center px-12">
          ...
          <div className="relative z-20 max-w-2xl">
            ...
            <h1 className="font-headline text-6xl md:text-7xl font-black text-white leading-tight tracking-tighter mb-6 uppercase">COLLEGE <br/><span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary">MARKETPLACE</span></h1>
            <div className="flex gap-4">
              <div className="glass-card bg-surface-container/40 border border-white/5 p-4 rounded-xl flex items-center gap-4 backdrop-blur-xl">
                <div className="text-3xl font-bold text-white font-headline">4.2k</div>
        ...
        <div className="px-8 -mt-12 relative z-30 grid grid-cols-12 gap-6">
          ...
          <div className="col-span-12 lg:col-span-8 space-y-6">
            <div className="glass-card bg-surface-container/60 border border-white/5 rounded-2xl p-8 shadow-2xl backdrop-blur-xl">
              <div className="flex justify-between items-end mb-8">
                <div>
                  <h2 className="font-headline text-2xl font-bold text-white uppercase tracking-tighter">공동구매 현황 모니터링</h2>
                  ...
                  <tbody>
                    <tr className="bg-surface-container-low hover:bg-surface-container transition-colors group">
                      <td className="px-4 py-4 rounded-l-xl">
                        <div className="flex items-center gap-3">
                          <div className="w-10 h-10 bg-surface-container-highest rounded-lg overflow-hidden flex-shrink-0 border border-white/5">
                          ...
                          <div><div className="text-sm font-bold text-white uppercase font-headline">인문학 전집</div><div className="text-[10px] text-on-surface-variant font-bold">LIB-001</div></div>
                        </div>
                      </td>
                    ...
                    <tr className="bg-surface-container-low hover:bg-surface-container transition-colors group">
                      <td className="px-4 py-4 rounded-l-xl font-bold">
                        <div className="flex items-center gap-3">
                          <div className="w-10 h-10 bg-surface-container-highest rounded-lg overflow-hidden border border-white/5">
                          ...
                          <div><div className="text-sm font-bold text-white uppercase font-headline">기술 한정판</div><div className="text-[10px] text-on-surface-variant font-bold">TECH-88</div></div>
                        </div>
                      </td>
                      <td className="px-4 py-4">
            ...
            <div className="glass-card bg-surface-container/60 border border-white/5 rounded-2xl p-8 shadow-2xl backdrop-blur-xl">
              <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-8">
                <h2 className="font-headline text-2xl font-bold text-white uppercase tracking-tighter">커뮤니티 관리 데스크</h2>
                <div className="flex items-center bg-surface-container-highest rounded-xl px-4 py-2 border border-outline-variant/10">
                  ...
                  <input className="bg-transparent border-none focus:ring-0 text-sm placeholder:text-on-surface-variant/40 w-full sm:w-48 text-white px-2 outline-none" placeholder="회원명 검색..." type="text"/>
                </div>
              </div>
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 bg-surface-container-low rounded-xl border-l-2 border-transparent hover:border-primary transition-all">
                  <div className="flex items-center gap-4 uppercase">
                    <div className="w-12 h-12 rounded-full overflow-hidden bg-surface-container-highest border border-white/5">
                    ...
                    <div><p className="text-sm font-black text-white headline-font tracking-tighter">Alex_Digital</p><p className="text-[10px] text-on-surface-variant font-bold tracking-widest leading-none">등급: 다이아몬드 익스플로러</p></div>
                  </div>
          ...
          <div className="col-span-12 lg:col-span-4 space-y-6 uppercase font-bold">
            <div className="glass-card bg-surface-container-high/80 border border-primary/20 rounded-2xl p-8 relative overflow-hidden">
              <div className="absolute -top-12 -right-12 w-32 h-32 bg-primary/10 blur-[60px] rounded-full"></div>
              <h3 className="font-headline text-xl font-bold text-white mb-2 tracking-tighter">마켓 파라미터 조절</h3>
              <p className="text-[10px] text-on-surface-variant mb-8 tracking-widest">전체 플랫폼 할인율 수정</p>
              <div className="space-y-8">
                <div>
                  <div className="flex justify-between items-center mb-4"><label className="text-[10px] text-primary tracking-[0.2em]">기본 할인율</label><span className="text-lg font-headline font-bold text-white">15%</span></div>
            ...
            <div className="glass-card bg-surface-container/60 border border-white/5 rounded-2xl p-8 shadow-2xl backdrop-blur-xl">
              <h3 className="font-headline text-xl font-bold text-white mb-6 tracking-tighter">진행 목표 관리</h3>
              <div className="space-y-6">
                <div>
                  <div className="flex justify-between text-[10px] mb-2 font-bold tracking-widest"><span className="text-on-surface-variant">모집 목표량</span><span className="text-white">72%</span></div>
                ...
                <div>
                  <div className="flex justify-between text-[10px] mb-2 font-bold tracking-widest"><span className="text-on-surface-variant">물류 처리율</span><span className="text-white">45%</span></div>
      ...
      <nav className="fixed bottom-0 w-full z-50 flex justify-around items-center px-6 pb-6 pt-3 md:hidden bg-[#0e0e0e]/80 backdrop-blur-2xl border-t border-[#8ff5ff]/10 rounded-t-[2rem] shadow-[0_-10px_40px_rgba(143,245,255,0.1)]">
        <button className="flex flex-col items-center justify-center bg-[#8ff5ff] text-[#0e0e0e] rounded-2xl p-2 shadow-[0_0_20px_rgba(143,245,255,0.6)] scale-110 transition-transform">
