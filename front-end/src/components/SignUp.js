  ...
  return (
    <main className="min-h-screen pt-20 flex items-center justify-center relative overflow-hidden bg-background">
      ...
      <section className="relative z-10 w-full max-w-2xl px-6 py-12">
        <div className="glass-panel border border-white/5 rounded-xl overflow-hidden shadow-2xl bg-[#1a1919]/60 backdrop-blur-xl">
          {/* Auth Header */}
          ...
          <div className="px-8 md:px-12 pb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <button className="group p-4 bg-surface-container-high border-2 border-primary rounded-lg transition-all active:scale-95 text-left">
              ...
              <button className="group p-4 bg-surface-container-low hover:bg-surface-container transition-all border border-white/5 rounded-lg active:scale-95 text-left">
          ...
          <form className="px-8 md:px-12 space-y-6">
            <div className="space-y-4">
              <div className="relative group">
                <input className="w-full bg-surface-container-highest border-none rounded-lg px-5 py-4 text-on-surface placeholder:text-outline focus:ring-0 transition-all font-body outline-none" placeholder="사용자 이름" type="text" />
                <div className="absolute bottom-0 left-0 w-0 h-[2px] bg-primary transition-all duration-300 group-focus-within:w-full shadow-[0_0_8px_#8ff5ff]"></div>
              </div>
              <div className="relative group">
                <input className="w-full bg-surface-container-highest border-none rounded-lg px-5 py-4 text-on-surface placeholder:text-outline focus:ring-0 transition-all font-body outline-none" placeholder="이메일 주소" type="email" />
                <div className="absolute bottom-0 left-0 w-0 h-[2px] bg-primary transition-all duration-300 group-focus-within:w-full shadow-[0_0_8px_#8ff5ff]"></div>
              </div>
              <div className="relative group">
                <input className="w-full bg-surface-container-highest border-none rounded-lg px-5 py-4 text-on-surface placeholder:text-outline focus:ring-0 transition-all font-body outline-none" placeholder="비밀번호" type="password" />
                <div className="absolute bottom-0 left-0 w-0 h-[2px] bg-primary transition-all duration-300 group-focus-within:w-full shadow-[0_0_8px_#8ff5ff]"></div>
              </div>
            </div>
            <button className="w-full bg-primary text-on-primary font-headline font-bold py-4 rounded-lg shadow-[0_0_20px_rgba(143,245,255,0.2)] hover:shadow-[0_0_30px_rgba(143,245,255,0.4)] transition-all active:scale-[0.98]" type="submit">
              계정 생성하기
            </button>
          </form>
          ...
          <div className="px-8 md:px-12 py-10">
            ...
            <div className="grid grid-cols-2 gap-4">
              <button className="flex items-center justify-center gap-3 bg-surface-container-low hover:bg-surface-container-high border border-white/5 py-3 rounded-lg transition-all group">
